...
const UserDashboard = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-2 relative">
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 bg-white p-4 flex justify-evenly rounded-3xl items-center transition-transform duration-300 mx-4 my-2 ${showFooter ? "translate-y-0" : "translate-y-full"
          }`}
      >
